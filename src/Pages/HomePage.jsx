        ...
        <section className="intro">
          <div id="text-wrapper">
            ...
            <p>
              ...
              Developer seeking to develop professional competence in the
              Software Engineering field by solving real life problems with his
              skills.
            </p>
          </div>
          <div id="right-anime">
        ...
        <section className="third-section">
          ...
          <div className="index-card">
            ...
            <div className="each-card">
              ...
              <a
                rel="noreferrer"
                href="https://github.com/sogobanwo/the-movie-db"
                target="_blank"
              >
                <FaGithub size="25px" />
              </a>
              <a
                rel="noreferrer"
                href="https://the-image-gallery.vercel.app/"
                target="_blank"
              >
                <FaGlobe size="25px" />
              </a>
